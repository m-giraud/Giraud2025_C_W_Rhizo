...
```
cd dumux-rosi/experimental/fixedPointIter2/scripts 
...
```
You can then recreate the graphs of the main text by going in the folder plot:
```
cd dumux-rosi/experimental/fixedPointIter2/plot
```
And running the jupyter notebook in the order given by the letter at the beginning of each notebook's name.
